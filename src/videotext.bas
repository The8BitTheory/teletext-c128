...
# DISPLAY QR-CODE #
####################
1700 SYS ML+9:RREGRA,RX,RY
1710 QL=RX+RY*256

1720 PRINT "RA:"RA",RX:"RX",RY:"RY
1730 PRINT "LOC: $"HEX$(QL)

# COPY QR CODE FROM RAM TO VRAM
1740 RTV QL,40000,128

# COPY SCREENBUFFER TO BACKBUFFER
1745 VMC S(R),S(ABS(R-1)),2000:VMC A(R),A(ABS(R-1)),2000

# COPY QR-CODE TO SCREENBUFFER
1750 VMC 40000,S(R)+722,4,32,80
1760 VMC 40000,S(R)+802,4,32,80
