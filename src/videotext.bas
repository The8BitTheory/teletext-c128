...
2220 VMF A(0)+1920,DEC("F0"),80:VMF A(1)+1920,DEC("F0"),80
2230 VMP S(0)+TP,"0-9:W"+CHR$(128)+"HLEN, R:REFRESH, O:OFFLINE, X:EXIT"
2240 VMP S(1)+TP,"Q:QR-CODE, F:2 MHZ, S:1 MHZ, D:AUF DISK "
2290 RETURN
