...
10 GRAPHIC0:DD=PEEK(186):DB=0

12 ML=DEC("3780"):BE=PEEK(4624)+PEEK(4625)*256
...
# RV:RETURN-VALUE FROM WIC64 INITIALIZATION
...
250 PRINT " "
251 PRINT  "  HOME ZU S.100    M (MENUE)  S.790  "
252 PRINT  "  CRSR R 1 VORW    CRSR L   1 RUECK  "
253 PRINT  "  CRSR DWN MERKEN  CRSR UP    HOLEN  "
254 PRINT  "  + VW SUBSEITE    -   RW. SUBSEITE  "
255 PRINT  "  R NEU LADEN      0..9  SEITE ANW.  "
256 PRINT  "  O OFFLINE MODUS  X EXIT            "
257 PRINT  "  D DUMP TO DISK   L LOOP            "
258 PRINT  " "
259 WINDOW 0,9,39,24,1
...
398 S=TI-S:IF DB THEN PRINT "POST-SUB TOOK"S"JIFFIES"
...
1020 S=TI-S:IF DB THEN PRINT "DL TOOK "S" JIFFIES"
