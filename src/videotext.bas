...
# ADDING 1024 BYTES TO BASIC-END TO USE FOR VCL COMMAND LIST
12 ML=DEC("3B80"):BE=PEEK(4624)+PEEK(4625)*256:
14 IF ML<=BE+1024 THEN PRINT "BASIC PROGRAM TOO LARGE. ENDS AT $"HEX$(BE+1024):END


16 DEF FN LB(ZZ)=DEC(RIGHT$(HEX$(ZZ),2))
17 DEF FN HB(ZZ)=DEC(LEFT$(HEX$(ZZ),2))


# SUPERCPU128 DETECTION
20 SC=ABS((PEEK(53433)AND128)=128)
22 IF SC=0 THEN SC=-1:PRINT "SUPERCPU DETECTED":ELSE SC=0
# DISABLE TURBO MODE DURING STARTUP
24 IF SC THEN POKE 53370,0


50 PRINT"LOADING VDCBASIC...";:BLOAD"VDCBASIC2G.1300",U(DD),B0:PRINT"DONE"
51 PRINT "VDCBASIC -"HEX$(PEEK(174)+PEEK(175)*256)
52 SYS DEC("1300")
...
110 BLOAD"TXTCHARSET3.VDC",U(DD),B0,P(BE+6144)
115 PRINT "TXTCHARSET -"HEX$(PEEK(174)+PEEK(175)*256)
120 FL=PEEK(174)+PEEK(175)*256-BE
130 RTV BE+6144,56*1024,FL
...
202 PRINT "C128TEXT.BIN -"HEX$(PEEK(174)+PEEK(175)*256)
205 GOSUB 2300
...
# 86/87 JIFFIES AT 2 MHZ
381 T=TI
382 FOR X=0 TO 22
384  VMC AS,AD,1,39,2
386  VMC AS,AD+1,1,39,2
388  AS=AS+39:AD=AD+80
389 NEXT:T=TI-T:PRINT "LOOP TIMER>"T
...
# PREPARE OFF-SCREEN TO ON-SCREEN COPY
# 1 LINE HAS 4 COMMANDS: VMC(5)=2 VMF(3)=4 VMP VMC(5)=2
# 88 JIFFIES WITH VMP, 69 WITHOUT VMP, 52 WITHOUT VMF(AND CALC OF V)
# 23 LINES X 4 COMMANDS = 92 COMMANDS
2400 LO=BE:PRINT "VCL 0="LO
2405 BANK0
2410 AD=A(0)+80:GOSUB 2450
2415 PRINT "VCL 1="LO
2420 AD=A(1)+80:GOSUB 2450
2425 BANK 15
2449 RETURN

2450 FOR X=0 TO 22
2460  C(0)=AS:C(1)=AD:C(2)=1:C(3)=39:C(4)=2:GOSUB 2500
2470  C(0)=AS:C(1)=AD+1:C(2)=1:C(3)=39:C(4)=2:GOSUB2500
2480  AS=AS+39:AD=AD+80
2490 NEXT
2495 POKE LO,0:LO=LO+1
2499 RETURN


# VMC WITH 5 PARAMETERS
2500 POKE LO,2: REM COMMAND-ID 1 BYTE
2505 POKE LO+1,FNLB(C(0)):POKE LO+2,FNHB(C(0))
2510 POKE LO+3,FNLB(C(1)):POKE LO+4,FNHB(C(1))
2515 POKE LO+5,FNLB(C(2)):POKE LO+6,FNHB(C(2))
2520 POKE LO+7,FNLB(C(3)):POKE LO+8,FNHB(C(3))
2525 POKE LO+9,FNLB(C(4)):POKE LO+10,FNHB(C(4))
2529 LO=LO+11
2530 RETURN

# VMF WITH 3 PARAMETERS
#2550 POKE LO,4: REM COMMAND-ID 1 BYTE
#2555 POKE LO+1,FNLB(C(0)):POKE LO+2,FNHB(C(0))
#2560 POKE LO+3,FNLB(C(1)):POKE LO+4,FNHB(C(1))
#2565 POKE LO+5,FNLB(C(2)):POKE LO+6,FNHB(C(2))
#2569 LO=LO+7
#2570 RETURN
...
# DRIVE ERRORS
61000 IF DS=74 THEN PRINT "LAUFWERK NICHT BEREIT.":PRINT"BITTE DISK EINLEGEN.":GOTO 61080
