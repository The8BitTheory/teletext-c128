...
# TODO: LEERE SEITEN IGNORIEREN
#       DUMP MODE MIT OFFLINE MODE VEREINHEITLICHEN
#       

5 ML=DEC("3100"):BE=PEEK(4624)+PEEK(4625)*256
...
312 VMP S(R)+1440,"SEITE KONNTE NICHT GELADEN WERDEN"
314 VMP S(R)+2160,"R UM NOCHMAL ZU VERSUCHEN"
316 VMP S(R)+2880,"O UM DEN OFFLINE MODUS ZU NUTZEN"
318 VMP S(R)+3600,"X UM ZU BEENDEN"
319 GOTO 400:SLOW
...
950 FL$=FL$+".VTX"
955 PRINT "SAVING "FL$" ...";
960 BSAVE ("@"+FL$),B0,P(DA) TO P(DA+2024)
970 PRINT "DONE"
980 RETURN
